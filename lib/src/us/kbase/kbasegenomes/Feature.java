...
public class Feature {
    ...
    private List<us.kbase.common.service.Tuple2 <String, Double>> orthologs;
    @JsonProperty("annotations")
    private List<us.kbase.common.service.Tuple3 <String, String, Double>> annotations;
    ...
    @JsonProperty("orthologs")
    public List<us.kbase.common.service.Tuple2 <String, Double>> getOrthologs() {
        return orthologs;
    }

    @JsonProperty("orthologs")
    public void setOrthologs(List<us.kbase.common.service.Tuple2 <String, Double>> orthologs) {
        this.orthologs = orthologs;
    }

    public Feature withOrthologs(List<us.kbase.common.service.Tuple2 <String, Double>> orthologs) {
        this.orthologs = orthologs;
        return this;
    }

    @JsonProperty("annotations")
    public List<us.kbase.common.service.Tuple3 <String, String, Double>> getAnnotations() {
        return annotations;
    }

    @JsonProperty("annotations")
    public void setAnnotations(List<us.kbase.common.service.Tuple3 <String, String, Double>> annotations) {
        this.annotations = annotations;
    }

    public Feature withAnnotations(List<us.kbase.common.service.Tuple3 <String, String, Double>> annotations) {
        this.annotations = annotations;
        return this;
    }
