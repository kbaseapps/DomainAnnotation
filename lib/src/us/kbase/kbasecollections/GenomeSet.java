...
public class GenomeSet {
    ...
    public GenomeSet withDescription(java.lang.String description) {
        this.description = description;
        return this;
    }
    ...
    public GenomeSet withElementOrdering(List<String> elementOrdering) {
        this.elementOrdering = elementOrdering;
        return this;
    }
    ...
    public GenomeSet withElements(Map<String, List<String>> elements) {
        this.elements = elements;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((("GenomeSet"+" [description=")+ description)+", elementOrdering=")+ elementOrdering)+", elements=")+ elements)+", additionalProperties=")+ additionalProperties)+"]");
    }
