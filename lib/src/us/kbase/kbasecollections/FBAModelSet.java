...
public class FBAModelSet {
    ...
    public FBAModelSet withElementOrdering(List<String> elementOrdering) {
        this.elementOrdering = elementOrdering;
        return this;
    }
    ...
    public FBAModelSet withElements(Map<String, List<String>> elements) {
        this.elements = elements;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((("FBAModelSet"+" [description=")+ description)+", elementOrdering=")+ elementOrdering)+", elements=")+ elements)+", additionalProperties=")+ additionalProperties)+"]");
    }
